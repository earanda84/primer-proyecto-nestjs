...
export class UsersService {
  ...
  // Metodo personzalizado con clausulas tipo SQL de TYPEORM, que busca un elemento por los campos y el select devuelve el arreglo con los campos específicos que requerimos buscar.
